-- ==============================================================================
-- GYM OS: Multi-Tenant PostgreSQL Relational Schema & Row Level Security (RLS)
-- ==============================================================================
...
-- ==============================================================================
-- 2. USER PROFILES (Staff & Owners linked to auth.users)
-- ==============================================================================
...
-- ==============================================================================
-- 5. MEMBERS (Gym Athletes & Clients)
-- ==============================================================================
...
-- ==============================================================================
-- 6. MEMBERSHIPS (Active & Past Subscriptions)
-- ==============================================================================
...
-- ==============================================================================
-- 7. ATTENDANCE (Live Desk Check-ins)
-- ==============================================================================
...
-- ==============================================================================
-- 8. PAYMENTS & INVOICES (GST Ledger)
-- ==============================================================================
...
-- ==============================================================================
-- 9. ACTIVITY LOGS (Audit Trail & Timeline)
-- ==============================================================================
...
-- ==============================================================================
-- INDEXES FOR PERFORMANCE & RELATIONAL JOINS
-- ==============================================================================
...
-- Function to safely extract tenant organization ID from authenticated user's profile
...
CREATE POLICY "Tenant isolation for trainers select"
    ON public.trainers FOR SELECT
    USING (organization_id = public.get_auth_organization_id());

DROP POLICY IF EXISTS "Tenant isolation for trainers insert" ON public.trainers;
CREATE POLICY "Tenant isolation for trainers insert"
...
CREATE POLICY "Tenant isolation for plans select"
...
CREATE POLICY "Tenant isolation for payments insert"
...
CREATE POLICY "Tenant isolation for activity logs select"
    ON public.activity_logs FOR SELECT
    USING (organization_id = public.get_auth_organization_id());

DROP POLICY IF EXISTS "Tenant isolation for activity logs insert" ON public.activity_logs;
CREATE POLICY "Tenant isolation for activity logs insert"
