...
export const Badge: React.FC<BadgeProps> = ({
  ...
  const getVariantStyles = () => {
    switch (variant) {
      ...
      case 'brand':
        return {
          container: 'bg-brand-500/10 text-brand-400',
          dot: 'bg-brand-400',
        };
      case 'cyan':
        return {
          container: 'bg-sky-500/10 text-sky-300',
          dot: 'bg-sky-400',
        };
      case 'purple':
        return {
          container: 'bg-purple-500/10 text-purple-300',
          dot: 'bg-purple-400',
        };
      case 'neutral':
      default:
        return {
          container: 'bg-surface-100 text-zinc-300',
          dot: 'bg-zinc-400',
        };
    }
  };
  ...
  return (
    <span
      className={twMerge(
        clsx(
          'inline-flex items-center rounded-md leading-none whitespace-nowrap select-none font-medium',
          sizeStyles[size],
