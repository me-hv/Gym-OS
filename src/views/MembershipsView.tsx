    ...
    <div className="space-y-6">
      ...
      <div>
        <div className="flex items-center justify-between mb-3">
          <h3 className="text-sm font-bold text-white tracking-tight">Active Plan Catalogue</h3>
          ...
          {plans.map((plan) => {
            ...
            return (
              <div
                ...
                className={`rounded-2xl p-6 cursor-pointer transition-all flex flex-col justify-between shadow-surface ${
                  isSelected
                    ? 'bg-surface-200 ring-1 ring-brand-500/50'
                    : 'bg-surface-300 hover:bg-surface-200/60'
                }`}
              >
                <div>
                  <div className="flex items-start justify-between gap-2 mb-2">
                    <div>
                      ...
                      <h4 className="text-base font-bold text-white mt-0.5 tracking-tight">{plan.name}</h4>
                    </div>
                    {plan.tag && (
                      <span className="text-[10px] font-mono font-bold bg-brand-500/20 text-brand-300 px-2 py-0.5 rounded-full">
                        {plan.tag}
                      </span>
                    )}
                  </div>
      ...
      <div className="rounded-2xl bg-surface-300 p-6 shadow-surface">
